...
pub use settings::{
    detect_default_ui_language, AppSettings, AutoEditMode, InferenceBackend, KEY_AUTOSTART,
    KEY_AUTO_EDIT, KEY_AUTO_EDIT_MODE, KEY_AUTO_LEARN, KEY_HOTKEY, KEY_INFERENCE_BACKEND,
    KEY_LLM_MODEL, KEY_ONBOARDING_DONE, KEY_PAUSE_PRESET, KEY_STT_LANGUAGE, KEY_UI_LANGUAGE,
    KEY_WHISPER_MODEL,
};
pub use snippets::{
