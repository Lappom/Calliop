...
pub use model::{
    ...
    is_corrupt_model_load_error, is_valid_model_file, legacy_qwen3_4b_model_path, model_exists,
    model_path, remove_legacy_qwen3_4b_model, LlmModel, LlmModelDownloadProgress, LlmModelError,
    DEFAULT_MODEL_FILE, LEGACY_QWEN3_4B_MODEL_FILE,
};
pub use prompt::{
