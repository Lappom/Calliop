...
pub use model::{
    ...
    legacy_medium_model_path, legacy_small_model_path, model_exists, model_path, models_dir,
    remove_legacy_medium_model, remove_legacy_small_model, ModelDownloadProgress, ModelError,
    WhisperModel, DEFAULT_MODEL_FILE, LEGACY_MEDIUM_MODEL_FILE, LEGACY_SMALL_MODEL_FILE,
};
